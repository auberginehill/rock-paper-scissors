                            ...
                            <p>
                                <table>
                                    <tr>
                                        ...
                                        <td style="padding:6px">
                                            <p>In 虫拳 (Mushi-ken) (<i>ken</i> (literally 'fist', 'grip', 'force' or 'strike') (拳) of the small animals, one of the games of 三竦み拳 ('sansukumi-ken', <i>ken</i> (literally 'fist', 'grip', 'force' or 'strike') (拳) of the three who are afraid of one another)) each participant shows one of the three hand signals after a synchronized countdown, which consists of one to three pre-steps (i.e. 1-signal to 3-2-1-signal), has elapsed. It is essential for the flow of the game for all participants (1) to know the number of pre-steps, for them to be certain, on which count the signal shall be released and (2) then to be in the same rhythm before the handsigns are signalled. If at any time the players are not in synch with their pre-steps (primes), it is recommended to restart the game, since having players deliver their throw at the same time is critical in ensuring a fair match. For fairness of the play, it is recommended to agree on the number of rounds to be played before the playing begins, so that each participant will know whether the outcome will be decided in one go or whether the game is in a tournament mode (best out of [uneven_number_of_rounds]). The released hand signs each have an inherent value in which one sign will always be better than the released hand sign and another hand sign will be worse than the released hand sign – furthermore it is ordained that all the signs together are valued successively so that they form an 'Infinite Loop of Betterness'. In 虫拳 (Mushi-ken) this loop is formed by valuing the hand signals as follows:</p>
                                            <ol>
                                                <table>
                                                    <tr>
...
<table>
 ...
 |_____/|_| |_|\___/ \__,_|___/_| |_|_|_|_|_| |_|\__, |
    ...
    <tr>
        ...
        <td style="padding:6px">
            ...
            <p>The popular beliefs associated with the various finger-guessing games in China in their earliest forms are unknown. Also, when considering the origin of the Chinese finger-guessing games, the earliest written mentions of the game being played come from very late second hand sources, usually from the period of the Ming (AD 1368–1644) and Qing dynasties (AD 1644–1912). In these sources concerning the history of the game the author usually claims as a fact that something, specified by the author, has happened over a thousand years ago. So, for instance, in 五雜組 (<i><a href="http://riccilibrary.usfca.edu/view.aspx?catalogID=16789">Wuzazu</a></i>, 'Five Miscellaneous Groups' or 'Miscellaneous notes classified into the five groups') written by <b>謝肇淛</b> (AD 1567–1624, a.k.a. <a href="http://www.airitilibrary.com/Publication/alDetailPrint?DocID=05779170-201106-201203050038-201203050038-39-77">Xie Zhaozhe</a>) the author <a href="http://www.betonhat.com/zhinan/rumen/17/17496.html">claims</a> that the tradition of finger-guessing games can be traced back to the period of Han Dynasty (206 BC – AD 220). It might be a safer assumption, though, that the various finger-guessing games in China were practitioned in the Sung period (AD 960–1279) or during the period of the Tang Dynasty (AD 618–907) at the earliest.</p>
            <p>On the other hand a game called 豁拳 (<i><a href="http://d777.com/cidian/huoquan3/">huoquan</a></i> or <i><a href="http://www.zidiantong.com/cd/h/huoquan56638.htm">huá quán</a></i>, 'to play the finger-guessing <a href="http://baike.so.com/doc/7627164-7901259.html">game</a>' (拳 <i>quán</i>, a '<a href="http://www.chinese-tools.com/tools/dictionary.html?dico=%E6%8B%B3">fist</a>')) is <a href="http://big5.huaxia.com/zhsx/sjfq/mscf/yy/2008/10/1187835.html">mentioned</a> in 六研齋筆記 (<i>Liuyanzhai biji</i> [004-31a], '<a href="http://riccilibrary.usfca.edu/view.aspx?catalogID=14057">Notes of the Liuyan Studio</a>' [004-31a] (筆記 <i>biji</i>, a '<a href="http://www.mandarintools.com/cgi-bin/wordlook.pl?word=%E7%AD%86%E8%A8%98&searchtype=chinese&where=whole">note</a>', 'essay') <a href="https://www.kanripo.org/text/KR3j0159/004">containing</a> the verse "俗飲, 以手指屈伸相博, 謂之豁拳, 又名豁指頭") by <b>李日華</b> (AD 1565–1635, a.k.a. <a href="http://www.dpm.org.cn/shtml/660/@/101817.html">Li Rihua</a>), seems to have been played in a similar fashion as the '<i>mora</i>' or '<i>morra</i>' of Italy or '<i>micare digitis</i>' of ancient Rome, in which the game was played between two people, each of whom would with their right hands show a dedicated hand sign signifying a number while at the same time they would predict the combined sum of numbers signalled by both players and say that number that aloud, and after simultaniously the hand signals were signalled and the sum of the numbers uttered at the same time by both players, whoever correctly predicted the sum of the numbers shown by both players, was the winner, if the other player didn't guess correctly, too (for further discussion about this topic, please see below under <i>micare digitis</i> and the quote from <b>J.J.M. de Groot</b>). This form of a finger-guessing game arrived to Japan in the form of <i>hon-ken</i> in which a Tō-on pronunciation ('Tang sound', 'Tang reading of Chinese characters in Japanese', introduced perhaps after the 13th century AD) of the numbers <a href="http://woodblockprints.org/index.php/Detail/Entity/Show/entity_id/618">was followed</a>, and as pointed out in Shogakukan's '<i>Nihon Kokugo Daijiten</i>' dictionary (AD 1972–1976 & AD 2000–2001), this might have happened in AD 1642, when <i>ken</i> (拳 literally 'fist', 'grip', 'force' or 'strike') arrived in Kyuushuu, spread to the Osaka area by around the Edo period (AD 1603–1868), and spread to Edo (now Tokyo) by about the Kyouhou period (i.e. about the AD 1720s). For a more detailed description of <i>hon-ken</i> , please see the discussion below under the header <i>mushi-ken</i>.</p>
            <p>Finger-guessing games in China are thought to have been concieved as a competitive game or a form of gambling, and with the passing of the ages many different finger-guessing game types arose. In the novels and poems of Ming (AD 1368–1644) and Qing dynasties (AD 1644–1912) the usage of finger-guessing games were frequently recorded. When comparing the more modern 'Rock-paper-scissors' to the Chinese version the most notable <a href="https://web.archive.org/web/20050425082051/http://www.jbrowse.com/text/janken.shtml">difference</a> is that in China the game is played in the 'Rock-Cloth-Scissors' form.</p>
            <ol>
                <p>
                    <table>
                        <tr>
 ...
 |_|  |_|\__,_|___/_| |_|_|      |_|\_\___|_| |_|                    -->
    ...
    <tr>
        <th></th>
        <td style="padding:6px">
            <h4>虫拳 (Mushi-ken) (<i>ken</i> (literally 'fist', 'grip', 'force' or 'strike') (拳) of the small animals, one of the games of 三竦み拳 ('sansukumi-ken', <i>ken</i> (literally 'fist', 'grip', 'force' or 'strike') (拳) of the three who are afraid of one another)) – Japanese</h4>
            <p><i>Mushi-ken</i> has been played in Okinawa and Amami until recently under the name of <i>busa</i>. <i>Mushi-ken</i> also seems to be one of the oldest forms of <i>ken</i> (拳) to have come to Japan from China, and is usually played with the right hand only. The earliest Japanese forms of the <i>ken</i> game (拳), known generically as '<i>mushi-ken</i>', are attributed to the Nara (AD 710–794) and Heian (AD 794–1185) periods. There seems to be iconographic evidence for it from the early 14th century AD (from <i>Ishiyamadera engi emaki</i>, '<a href="http://himoji.kanagawa-u.ac.jp/publication/pdf/result_report_01/1103_01-011.pdf">Legends of the Ishiyamadera Temple</a>'), and under Chinese influence it started to become immensely popular in urban circles in the middle of the eighteenth century AD.</p>
            <p><i>Sansukumi</i> is expounded in the book called the <i>Kan'inshi</i>, which describes how the snake fears the slug, the slug fears the frog, and the frog fears the snake. Each of the three parties holds the others in check, so that the three cannot move – in short, this is the same relationship as between rock (<i>guu</i>), paper (<i>paa</i>), and scissors (<i>choki</i>) in <i>jan-ken</i>, which was developed at a later stage, perhaps in the late nineteenth century AD. The <i>kens</i> of the Edo period (AD 1603–1868) included for instance <i>shouya-ken</i> and <i>mushi-ken</i>.</p>
            <p>From the Genroku (AD 1688–1704) to the Bunsei period (AD 1818–1830), however, a <i>ken</i> (拳) which was called the 'original ken' (<i>hon-ken</i>) or 'numbers-ken' (<i>kazu-ken</i>) was the main <i>ken</i> (拳) played in Japan. In this <i>hon-ken</i> two people sit opposite each other and show a certain number with their right hands with a dedicated hand sign, while shouting the expected sum of the numbers shown by both players. If both players shout the wrong number (i.e. a number that is different from the sum of the numbers shown by both players) or if both players shout the correct combined sum of the numbers shown by both players as a result, the outcome is a draw or <i>aiko</i>. The one, who alone shouts the correct combined sum of the numbers indicated by both players in a round, wins that round. The left hands are used to count the respective wins.</p>
            <p>The Japanese had a special way of calling out the numbers, however, since in the eighteenth-century AD the Japanese players called the numbers in Chinese or in what they thought to be Chinese. As a result they did not shout "<i>ichi, ni, san</i>" or "<i>hitotsu, jutatsu, mittsu</i>" in accordance with the usual Japanese way for saying "one, two or three". Instead they counted "<i>ikkō, ryan, sanna</i>" and everybody who wanted to join in this game had to study these numbers before they could start to participate. Since the name of this <i>ken</i>-game means 'original ken', it could be assumed that it came to Japan among the earliest '<i>sansukumi-ken</i>' or even earlier. According to Shogakukan's '<i>Nihon Kokugo Daijiten</i>' dictionary (AD 1972–1976 & AD 2000–2001), <i>ken</i> (拳) arrived in Kyuushuu in AD 1642, spread to the Osaka area by around the Edo period (AD 1603–1868), and spread to Edo (now Tokyo) by about the Kyouhou period (i.e. about the AD 1720s). Because it first arrived in Nagasaki, it was sometimes called '<i>nagasaki-ken</i>' or '<i>kiyou-ken</i>' (Kiyou being the old name for Nagasaki).</p>
            <p>In <i>hon-ken</i>, if one points the thumb alone, it counts for 'one' (<i>ikkō</i>), opening the thumb and forefinger together counts 'two' (<i>ryan</i>), pointing the other three fingers together counts 'three' (<i>san</i>), opening four fingers together, but keeping the thumb curled up, counts 'four' (<i>sū</i>), opening all five digits together counts 'five' (<i>go</i>) and closing the fist completely counts 'six' (<i>mui</i>). In addition to this, calls for higher numbers are used: 'seven' (<i>chie</i>); 'eight' (<i>pama</i>); 'nine' (<i>kwai</i>); 'ten' (<i>tōrai</i>) – and, in the original game but already obsolete by AD 1830, 'zero' (<i>mu</i>). Usually the calls were in Tō-on pronunciation ('Tang sound', 'Tang reading of Chinese characters in Japanese', introduced perhaps after the 13th century AD) (唐音), but several alternative calls for each number were also used in <i>hon-ken</i>. <b>Ōta Nanpo</b>, in <i>Hannichi Kanwa</i>, illustrates gestures and calls from a manual published in AD 1746, and together with his friends he even devised a kind of <i>kazu-ken</i>, which he describes in <i>Shichi-ken Zushiki</i> in AD 1779.</p>
            <p>The two players in <i>hon-ken</i> are known as <i>kō</i> and <i>otsu</i>. Each makes a gesture with his right hand, and a call which is his guess at the sum of his move and his opponent's. If both guess right or if neither does, the result is inconclusive – otherwise one player wins the round, and keeps his score (<i>kazutori</i>) on the fingers of his left hand. Usually a game consists of ten rounds. Prints depicting the game of <i>ken</i> (拳) are called <i>ken no e</i> (拳の絵). <i>Ken</i> was often played as a drinking game and was incorporated into several kabuki plays as a dance. The <a href="http://www.kuniyoshiproject.com/Actors%20playing%20the%20game%20of%20ken,%20Part%20I.htm">prints with small human figures</a> usually illustrate these dance steps.</p>
            </p>
            ...
            <h4><i>Hon-ken</i> – A Japanese Game with custom Chinese Vocabulary in Tō-on pronunciation (唐音)</h4>
            <ol>
                <p>
                    <table>
                        <tr>
            ...
            <table>
                ...
                <tr>
                    <td style="padding:6px"><a href="https://www.futurelearn.com/courses/japanese-rare-books-culture/1/steps/74600">The introduction of the Chinese script and the origins of kana</a></td>     
                </tr>                              
                <tr>
                    <td style="padding:6px"><a href="https://web.archive.org/web/20050425082051/http://www.jbrowse.com/text/janken.shtml">Jan Ken Pon - Some Historical Data</a></td>
                </tr>
 ...
 |_|  |_|_|\___\__,_|_|  \___| |_____/|_|\__, |_|\__|_|___/
    ...
    <tr>
        ...
        <td style="padding:6px">
                        ...
                        <ol>
                            <ol>
                                <blockquote>
                                    ...
                                    <p>
                                        <b>Aurelius Augustinus Hipponensis</b> (AD 354–430, a.k.a. Augustine of Hippo): 'De Trinitate' Liber VIII.5.8 (On the trinity, Book VIII Chapter 5.8)
            ...
            <p>...and to the poetry, as Titus Calpurnius Siculus (perhaps second or third century AD) in his second pastoral poem in '<i>Eclogue</i>' (sometimes inscribed as <i>Crotale</i>) has his characters Astacus and Idas about to be endulged in an amoebaean song contest, when <b>Thyrsis</b> (which might be a nod to the same Thyrsis, which appears on the Bucolic Idyll 1 by <b>Θεόκριτος</b> (c. 3rd century BC, a.k.a. Theokritos, a.k.a. Theocritus, the creator of ancient Greek bucolic poetry) declares that the prize should be glory alone and that the starter should be decided by the best score out of three rounds of '<i>Micare Digitis</i>':</p>
             <ol>
                <ol>
                    <ol>
                        <ol>
                            <ol>
                                <blockquote>
                                    ...
                                    <p>
                                        (Calp. Sic. 2, 12–27) <b>Titus Calpurnius Siculus</b> (perhaps second or third century AD): 'Eclogis Calpurni Siculi' 2, 12–27 (Eclogues of Calpurnius Siculus 2, 12–27)
                                        <br /><a href="http://penelope.uchicago.edu/Thayer/L/Roman/Texts/Calpurnius_Siculus/Eclogues/2*.html">'Eclogis Calpurni Siculi' 2, 12–27</a> (Latin)
                                        <br /><a href="https://ia601406.us.archive.org/33/items/ecloguesofcalpur00calpuoft/ecloguesofcalpur00calpuoft.pdf">Eclogues of Calpurnius Siculus 2, 12–27 and M. Aurelius Olympius Nemesianus</a> (PDF, 10.4 MB) (Latin)
                                        <br /><a href="http://penelope.uchicago.edu/Thayer/L/Roman/Texts/Calpurnius_Siculus/Eclogues/2*.html">Eclogues of Calpurnius Siculus 2, 12–27</a> (English)
                                    </p>
                                </blockquote>
                                <h4>Translation</h4>
                                <blockquote>
            ...
            <p>When trying to find out the origins of the game of '<i>micare digitis</i>', as already pointed out by Marcus Tullius Cicero (106–43 BC, a.k.a. Κικέρων), the proverb concerning playing '<i>micare digitis</i>' in the dark was already quite old in his own time (Cic. Off. 3.19.77), but furthermore in another part of '<i>De Officiis</i>' Cicero seems also to be indicating that the praxis of '<i>micare digitis</i>' was not unknown to the Greek either, when he is discussing the works of <b>Ἑκάτων</b> (c. first-second century BC, a.k.a. Hecaton of Rhodes, a.k.a. Hecaton) (Cic. Off. 3.23.89–90):</p>
            <ol>
                <ol>
                    <ol>
                        <ol>
                ...
                <ol>
                    <ol>
                        <ol>
                            <ol>
                                <blockquote>
                                    <p><i>Ἀνεγνώσθη Πτολεμαίου τοῦ Ἡφαιστίωνος περὶ τῆς εἰς πολυμαθίαν καινῆς ἱστορίας λόγοι Ϛ'. Χρήσιμον ὡς ἀληθῶς τὸ βιβλίον τοῖς περὶ τὴν ἱστορικὴν πολυμαθίαν πονεῖν ὡρμημένοις· ἔχει γὰρ δοῦναι συνειλεγμένα βραχεῖ χρόνῳ εἰδέναι, ἃ σποράδην τις τῶν βιβλίων ἀναλέγειν πόνον δεδεγμένος μακρὸν κατατρίψει βίον. Ἔχει δὲ πολλὰ καὶ τερατώδη καὶ κακόπλαστα, καὶ τὸ ἀλογώτερον, ὅτι καὶ ἐνίων μυθαρίων αἰτίας, δι´ ἃς ὑπέστησαν, ἀποδιδόναι πειρᾶται.
                                    <br />
                                    <br />Ὁ μέντοι τούτων συναγωγεὺς ὑπόκενός τέ ἐστι καὶ πρὸς ἀλαζονείαν ἐπτοημένος, καὶ οὐδ´ ἀστεῖος τὴν λέξιν. Προσφωνεῖ δὲ τὸ σύνταγμα Τερτύλλᾳ τινί, ἣν καὶ δέσποιναν ἀνυμνεῖ καὶ τὸ φιλολόγον αὐτῇ καὶ πολυμαθὲς ἐπιφημίζει. Διαβάλλει δ´ ἐνίους καὶ τῶν πρὸ αὐτοῦ οὐχ ὑγιῶς ἐπιβαλόντας τῇ ὑποθέσει. Τά γε μὴν πλεῖστα τῶν ἱστορουμένων ὑπ´ αὐτοῦ, καὶ ὅσα τοῦ ἀπιθάνου καὶ ἀπίστου καθαρεύει, παρηλλαγμένην ὅμως καὶ οὐκ ἄχαρι εἰδέναι τὴν μάθησιν ἐμπαρέχει.
                                    <br />(...)
                                    <br />Τὸ δὲ δʹ διεξέρχεται ὡς Ἑλένη πρώτη ἐπενόησε τὸν διὰ δακτύλων κλῆρον, καὶ Ἀλεξάνδρῳ λαχοῦσα ἐνίκησε· καὶ ὡς Ἀφροδίτης εἴη θυγάτηρ.</i></p>
                                    <p>
                                        <b>Φώτιος</b> (c. AD 810–893, a.k.a. Photios I of Constantinople, a.k.a. Photius, a.k.a. Fotios, the Ecumenical Patriarch of Constantinople AD 858–867 and AD 877–886): Βιβλιοθήκη (Library) or Μυριόβιβλος (Myriobiblos, "Ten Thousand Books"), 190. Ptolemy Chennus, New History
            ...
            <p>In its rich history '<i>Micare Digitis</i>' has had a wide cultural impact, which is demonstrated to us, for instance, not only by the note made earlier by Sepp Linhart (when discussing <i>mushi-ken</i>) that in Japan, a game with a similar ruleset to that of '<i>Micare Digitis</i>' was called the 'original ken' (<i>hon-ken</i>) or the 'numbers-ken' (<i>kazu-ken</i>) and was the main <i>ken</i> (拳) played in Japan from the Genroku period (AD 1688–1704) to the Bunsei period (AD 1818–1830), but also by J.J.M. de Groot, since when discussing the annual festivals celebrated in Émoi he makes a remark that '<i>Micare Digitis</i>' as a game with the identical set of rules is also known in China by the name '<i>hoah-koûn</i>' («crier le poing» or "shout fist"), which might be the same game, which is called 豁拳 (<i><a href="http://d777.com/cidian/huoquan3/">huoquan</a></i> or <i><a href="http://www.zidiantong.com/cd/h/huoquan56638.htm">huá quán</a></i>, 'to play the finger-guessing <a href="http://baike.so.com/doc/7627164-7901259.html">game</a>' (拳 <i>quán</i>, a '<a href="http://www.chinese-tools.com/tools/dictionary.html?dico=%E6%8B%B3">fist</a>')) and is <a href="http://big5.huaxia.com/zhsx/sjfq/mscf/yy/2008/10/1187835.html">mentioned</a> in 六研齋筆記 (<i><a href="https://www.kanripo.org/text/KR3j0159/004">Liuyanzhai biji</a></i> [004-31a], <a href="http://riccilibrary.usfca.edu/view.aspx?catalogID=14057">'Notes of the Liuyan Studio'</a> [004-31a] (筆記 <i>biji</i>, a '<a href="http://www.mandarintools.com/cgi-bin/wordlook.pl?word=%E7%AD%86%E8%A8%98&searchtype=chinese&where=whole">note</a>', 'essay')) by <b>李日華</b> (AD 1565–1635, a.k.a. <a href="http://www.dpm.org.cn/shtml/660/@/101817.html">Li Rihua</a>):</p>
            <ol>
                <ol>
                    <ol>
                        <ol>
                            <ol>
                                <blockquote>
                                    ...
                                    <p>
                                        ...
                                        <br /><b>Sepp Linhart:</b> <a href="https://minpaku.repo.nii.ac.jp/?action=pages_view_main&active_action=repository_view_main_item_detail&item_id=3017&item_no=1&page_id=13&block_id=21">Some Thoughts on the Ken Game in Japan: From the Viewpoint of Comparative Civilization Studies</a>
                                    </p>
                                </blockquote>
                            </ol>
                        </ol>
